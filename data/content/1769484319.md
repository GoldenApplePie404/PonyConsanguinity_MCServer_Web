...
<p align="center">
  ...
  <a href="#-ai-agent-远程框架">AI Agent 远程框架</a> •
  <a href="#-系统配置">系统配置</a> •
  <a href="#-开发指导">开发指导</a> •
  <a href="#-安全配置">安全配置</a>
</p>
...
##### 声明：此充值系统目前还处于测试阶段，暂未进行安全性测试，请勿随意使用，若遇上安全漏洞造成的财产损失，作者与本站不承担任何责任！！！
##### 声明：此充值系统目前还处于测试阶段，暂未进行安全性测试，请勿随意使用，若遇上安全漏洞造成的财产损失，作者与本站不承担任何责任！！！
##### 声明：此充值系统目前还处于测试阶段，暂未进行安全性测试，请勿随意使用，若遇上安全漏洞造成的财产损失，作者与本站不承担任何责任！！！
---
...
// 明文 Key 只在创建时展示一次，config 仅存哈希；详见「AI Agent 远程框架」章节
// define('MCP_SERVICE_KEYS', [
...
| MCP_SERVICE_KEYS | MCP 远程鉴权表（SHA256 哈希 => 角色） | 见「AI Agent 远程框架」章节 |
